#ifndef CNN_DEPTREELSTM_H_
#define CNN_DEPTREELSTM_H_
...
struct DepTreeLSTMBuilder : public RNNBuilder {
  DepTreeLSTMBuilder() = default;
  explicit DepTreeLSTMBuilder(unsigned N, //Max branching factor
                              unsigned layers,
                              unsigned input_dim,
                              unsigned hidden_dim,
                              Model* model,
